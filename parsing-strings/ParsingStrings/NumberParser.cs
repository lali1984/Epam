...
namespace ParsingStrings
{
    public static class NumberParser
    {
        ...
        {
            return _ = ushort.TryParse(str, out result);
        }
        ...
        {
            return _ = long.TryParse(str, out result);
        }
        ...
        {
            return _ = ulong.TryParse(str, out result);
        }
