...
namespace NumeralSystems
{
    public static class Converter
    {
        ...
        public static string GetPositiveOctal(this int number) => number < 0 
            ? throw new ArgumentException(nameof(number).ToString()) 
        ...
        /// <exception cref="ArgumentException">Thrown if number is less than zero.</exception>
        public static string GetPositiveDecimal(this int number) => number < 0
           ? throw new ArgumentException(nameof(number).ToString())
        ...
        /// <exception cref="ArgumentException">Thrown if number is less than zero.</exception>
        public static string GetPositiveHex(this int number) => number < 0 
            ? throw new ArgumentException(nameof(number).ToString())
            : Convert.ToString(number, 16).ToUpper(CultureInfo.CurrentCulture);
        ...
        /// <exception cref="ArgumentException">Thrown if number is less than zero.</exception>
        public static string GetPositiveRadix(this int number, int radix) => number < 0 
            ? throw new ArgumentException(nameof(number).ToString())
            : Convert.ToString(number, radix).ToUpper(CultureInfo.CurrentCulture);
        ...
        /// <returns>The equivalent string representation of the number in a specified radix.</returns>
        /// <exception cref="ArgumentException">Thrown if radix is not equal 8, 10 or 16.</exception>
        public static string GetRadix(this int number, int radix) => radix != 8 && radix != 10 && radix != 16 
            ? throw new ArgumentException(nameof(number).ToString())
            : Convert.ToString(number, radix).ToUpper(CultureInfo.CurrentCulture);
    }
}
